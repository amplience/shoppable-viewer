...
<div align="center">
    <a href="http://amplience.com/">
        <img src="http://classic.cdn.media.amplience.net/i/csdemo/pdf viewer?v=2" alt="Amplience Content Authoring" title="Amplience" style="margin-left:auto; margin-right:auto; display:block;" width="890px" height="300px" />
    </a>
</div>
...
setData: {
        type: 's',
        account: 'csdemo',
        path: 'https://classic.cdn.media.amplience.net/',
...
jsonData: [
        {
            "type": "img",
            "src": "https://classic.cdn.media.amplience.net/i/csdemo/CA-catalogue_page1",
            "width": 1240,
            "height": 1500,
            "format": "JPEG",
            "opaque": "true"
            ...
            "type": "img",
            "src": "https://classic.cdn.media.amplience.net/i/csdemo/CA-catalogue_page2",
            "width": 2479,
            "height": 1500,
            "format": "JPEG",
            "opaque": "true"
